  ...
  head: () => ({
    meta: [
      { title: "AI Image Analyzer – Analyze Images With AI | SnapInfo" },
      {
        name: "description",
        content:
          "Use SnapInfo as a free AI image analyzer to analyze photos and identify objects, plants, animals, food, and more with AI.",
      },
      {
        property: "og:title",
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          url: "https://snap-insight-go.lovable.app/",
          description:
            "A web-based AI image analyzer for identifying and describing subjects in uploaded or captured photos.",
        }),
      },
    ],
  }),
    ...
    >
      <header className="w-full max-w-md flex items-center justify-between mb-8">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold tracking-tight text-foreground">SnapInfo</span>
        </div>
        {status !== "idle" && (
          <button
            onClick={reset}
      ...
      <div className="w-full max-w-md mt-12 space-y-10">
        ...
        <section>
          <h2 className="text-2xl font-bold mb-5 text-foreground">AI Image Analyzer Examples</h2>
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              {
                title: "Identify a Plant From a Photo",
                description: "Photograph a leaf, flower, or whole plant to get a possible name and helpful visible details.",
                icon: Leaf,
              },
              {
                title: "Identify an Animal From a Photo",
                description: "Analyze a clear photo of a pet, bird, insect, or other animal to learn what it may be.",
                icon: PawPrint,
              },
              {
                title: "Identify Food From an Image",
                description: "Use a food photo to recognize a dish, ingredient, snack, or other visible item.",
                icon: Utensils,
              },
              {
                title: "Identify an Object From a Picture",
                description: "Upload a picture of a tool, product, gadget, or household object for an AI-generated description.",
                icon: PackageSearch,
              },
            ].map(({ title, description, icon: Icon }) => (
              <article key={title} className="rounded-2xl bg-card border border-border p-5 shadow-sm">
        ...
        <section className="rounded-2xl bg-card border border-border p-6 shadow-sm">
          <h2 className="text-2xl font-bold mb-3 text-foreground">Useful Ways to Analyze Everyday Photos</h2>
          <p className="text-foreground/80 leading-relaxed">
            SnapInfo can help you explore objects, plants, animals, food, products, and everyday
            photos. It describes visible features and suggests what the main subject may be, giving
            you a useful starting point for further research. Results are AI-generated, so confirm
            important identifications with a trusted source.
          </p>
        </section>
        ...
        <FAQSection
          items={[
            ...
            {
              question: "Can AI identify an object from a picture?",
              answer:
                "Yes. AI can examine visible shapes, colors, textures, and context to suggest what an object may be. Results depend on the clarity of the photo and may not always be perfect.",
            },
            {
              question: "Can AI identify a plant from a photo?",
              answer:
                "AI can often suggest a plant name from a clear photo of its leaves, flowers, or overall shape. Confirm important plant identifications with a reliable botanical source.",
            },
            {
              question: "Can AI identify an animal from a photo?",
              answer:
                "AI can often recognize common animals and describe visible features. A clear, well-lit photo with the animal in focus gives it more useful visual information.",
            },
            {
              question: "Can SnapInfo analyze food images?",
              answer:
                "Yes. SnapInfo can analyze photos of dishes, ingredients, and packaged food, then provide an AI-generated description of what is visible.",
            },
            {
...
function IdleScreen({ onPick, onCamera }: { onPick: () => void; onCamera: () => void }) {
  return (
    <div className="flex flex-col items-center text-center">
      ...
      <h1 className="text-3xl font-bold mb-3 text-foreground text-balance">
        AI Image Analyzer – Identify Anything From a Photo
      </h1>
      <p className="text-muted-foreground mb-8 text-balance leading-relaxed">
        Analyze images with AI to identify objects, plants, animals, food, and more. Upload a photo
        or take a picture and get an instant AI-powered analysis.
      </p>
